...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-blue-700  dark:bg-blue-600 p-2 fixed w-screen shadow-lg">
        <div className="max-w-screen-xl mx-auto p-4">
          <div className="flex items-center justify-between">
            <span className="text-2xl font-semibold text-gray-900 dark:text-white mr-4 lg:mr-40 font-mono">
              Image Search
            </span>
